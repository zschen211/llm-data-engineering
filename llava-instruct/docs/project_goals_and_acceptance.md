# llava-instruct 项目目标与验收标准

对应《大模型数据工程》项目三：LLaVA 多模态指令数据工厂
（https://datascale-ai.github.io/data_engineering_book/part14/p03_llava_instruct/）
...
- `llava_instruct.jsonl` — 基础指令样本
- `llava_alignment.jsonl` — 对齐样本（含 bbox）
- `llava_interleaved.jsonl` — 多图交错样本
