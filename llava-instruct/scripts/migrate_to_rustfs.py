...
service can be restarted with ``LLAVA_STORAGE_BACKEND=rustfs`` (the default
...
def main() -> int:
    ...
    parser.add_argument("--data-dir", default=os.environ.get("LLAVA_DATA_DIR", "data"))
    parser.add_argument(
    ...
    parser.add_argument(
        "--bucket", default=os.environ.get("RUSTFS_BUCKET", "llava-assets")
    )
