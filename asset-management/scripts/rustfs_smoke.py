#!/usr/bin/env python3
"""RustFS integration smoke test for the asset-management asset layer.
...
from asset_management.log import setup_logging
...
def main() -> int:
    ...
    bucket = os.environ.get("RUSTFS_BUCKET", "asset-assets")
